...
import org.hvkz.hvkz.modules.chats.window.ui.OnDateChangeListener;
...
public class MessagesListView extends RecyclerView
{
    ...
    public void init(OnDateChangeListener dateChangeListener, Callback<Void> keyboardCallback) {
